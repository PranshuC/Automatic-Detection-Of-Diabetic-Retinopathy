...
/*                                                                          */
/*  NAME                                                                    */
/*      IMG_erode_bin_d.c -- Example file for IMG_erode_bin                 */
/*                                                                          */
/*  USAGE                                                                   */
/*      This file contains code for demonstrating the C62x IMGLIB           */
/*      IMG_erode_bin function. All inputs to the function contain random   */
/*      data. The assembly version of IMG_erode_bin is called and the       */
...
const unsigned char  in_data[N] = 
{
     ...
     0x3C,  0x60,  0xC2,  0x1A,  0x2C,  0xDC,  0x62,  0x44,
     ...
     0x6C,  0x62,  0xAB,  0x14,  0xBB,  0xDF,  0x7C,  0x70,
     ...
     0x24,  0x50,  0x70,  0x20,  0x62,  0xC0,  0x2E,  0x3C,
     ...
     0x8A,  0x31,  0x99,  0xBE,  0xF9,  0xC0,  0x62,  0xFC,
     ...
     0x88,  0x7C,  0x07,  0x62,  0x52,  0xCF,  0xB2,  0x0F,
...
/* ======================================================================== */   
    IMG_erode_bin(in_data, out_data_asm, mask, COLS);
