...
/*                                                                          */
/*  NAME                                                                    */
/*      IMG_idct_8x8_d.c -- Example file for IMG_idct_8x8                   */
/*                                                                          */
/*  USAGE                                                                   */
/*      This file contains code for demonstrating the C62x IMGLIB           */
/*      IMG_idct_8x8 function. All inputs to the function contain random    */
/*      data. The assembly version of IMG_idct_8x8 is called and the        */
...
void IMG_idct_8x8_c(short * idct_data, unsigned NUM_idctS);

/* ======================================================================== */
/*  IMGLIB function-specific alignments. Refer to the                       */
/*  TMS320C62x IMG Library Programmer's Reference for details.              */
/* ======================================================================== */
#pragma DATA_ALIGN(idct_data_asm, 4);
#pragma DATA_ALIGN(idct_data_c, 4);
...
/* Note that one more 8x8 block is need for intermediate results.           */
short  idct_data_asm[64*(num_idcts+1)] = 
{
...
/* Note that one more 8x8 block is need for intermediate results.           */
short  idct_data_c[64*(num_idcts+1)];
...
/* ======================================================================== */   
    IMG_idct_8x8(idct_data_asm, num_idcts);
    
/* ======================================================================== */
/*  Call natural-C version                                                  */
/* ======================================================================== */
    IMG_idct_8x8_c(idct_data_c, num_idcts);

/* ======================================================================== */
/*  Compare outputs using mem_compare() in support.c.  If different,        */
/*  mem_compare() displays location of failures.                            */
/* ======================================================================== */
    test = mem_compare(idct_data_asm, "idct_data_asm", idct_data_c, "idct_data_c", 64*num_idcts*sizeof(short));
    if (test == 0) 
    {
